...
import {
  Search, SlidersHorizontal, Shuffle, Flame, List,
  Workflow,
  Database,
  Terminal,
  Cpu,
        ...
        <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide mb-3">
          {TAGS.map((tag) => (
            <button
              ...
              className={`px-3 py-1.5 rounded-full text-xs border flex-shrink-0 transition-all ${activeTag === tag
          ...
          {TOPICS.map((t) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-1.5 px-4 py-1.5 rounded-full text-sm border flex-shrink-0 transition-all ${activeTopic === t.label
            ...
            <div className="flex gap-1">
              {DIFFICULTIES.map(d => (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-xs font-medium border transition-all ${activeDifficulty === d
                    ? 'bg-gray-900 text-white border-gray-900'
                    : 'bg-white text-gray-500 border-gray-200 hover:border-gray-400'
                    }`}
                >
